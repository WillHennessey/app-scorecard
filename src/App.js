...
import { FiBox, FiShield, FiMonitor, FiTwitter, FiLock, FiCode, FiSettings } from "react-icons/fi";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-16 px-6 pb-8 flex">
        {/* Sidebar */}
        <aside className="w-64 fixed left-0 bg-white h-full shadow-md">
        ...
        <div className="flex-1 ml-64 p-8">
          <h2 className="text-2xl font-bold mb-8">Services Overview</h2>
          <Dashboard />
        </div>
      </main>
    </div>
